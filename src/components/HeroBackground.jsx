...
const HeroBackground = () => {
  return (
    <section>
      <div className={classes["hero-bg-container"]}>
        {/* Left Block */}
        <div className={classes["hero-bg-left-block"]}>
          <h3>Hello!</h3>
          <h1>I'm Aleem-Ul-Hassan <span><FiArrowUpRight className={classes["left-block-icon"]}/></span></h1>
        ...
        <div className={classes["hero-bg-right-block"]}>
          <div className={classes["right-block-top-content"]}>
            <div><TbArrowBigDownLines className={classes["right-block-icon"]}/></div>
